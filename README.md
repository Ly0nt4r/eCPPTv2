...
Un búfer es una sección secuencial de memoria asignada para contener cualquier cosa, desde una cadena de caracteres hasta una matriz de números enteros. Un desbordamiento de búfer, o desbordamiento de búfer, ocurre cuando se colocan más datos en un búfer de longitud fija de los que el búfer puede manejar. La información adicional, que tiene que ir a alguna parte, puede desbordarse en el espacio de memoria adyacente, corrompiendo o sobrescribiendo los datos contenidos en ese espacio. Este desbordamiento suele provocar un bloqueo del sistema, pero también crea la oportunidad para que un atacante ejecute código arbitrario o manipule los errores de codificación para provocar acciones maliciosas.
